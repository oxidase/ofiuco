...
from python.private.lock_parser import Package, main, remove_cycles
...
class TestInstallSubcommand(unittest.TestCase):
    ...
    def test_sphinx_lock(self):
        ...
        assert (
            r"sha256:53dd9d5e3d29f95acd5de6802e909ada8d8d8cfa37a3ac64836f3bc4bc5512db"
            in build_file
        )
        assert (
            r'{"cffi": "platform_python_implementation == \\\"PyPy\\\""}' in build_file
        )
    ...
    def test_airflow_lock(self):
        ...
        # assert "apache-airflow@2.7.2 -> " in info_log
